...
export function AuthShell({
  ...
  description,
  children,
  statusLabel = 'Protected workspace',
}: AuthShellProps) {
  return (
        ...
        <div className="relative hidden overflow-hidden border-r border-sidebar-border bg-sidebar text-sidebar-foreground lg:flex lg:flex-col">
          ...
          <div className="relative flex flex-1 items-end px-10 pb-12 xl:px-14 xl:pb-16">
            <div className="max-w-2xl">
              ...
              <p className="max-w-xl text-[clamp(3rem,5.5vw,5.75rem)] leading-[0.94] font-semibold tracking-[-0.06em] text-balance">
          ...
          <div className="flex flex-1 items-center justify-center py-12">
            <div className="w-full max-w-[25rem]">
              <div className="mb-9">
                ...
                <h1 className="mt-3 text-[clamp(2rem,4vw,2.65rem)] leading-[1.05] font-semibold tracking-[-0.045em] text-card-foreground">
                  {title}
                </h1>
